...
const VideoGrid: React.FC = () => {
  ...
  // Layout logic
  const getGridClass = () => {
    if (totalVideos === 1) return 'grid-cols-1 max-w-4xl mx-auto'; // Solo mode: căn giữa
  ...
  return (
    // Quan trọng: h-full w-full và flex items-center để căn giữa video theo chiều dọc
